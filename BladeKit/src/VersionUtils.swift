...
public class VersionUtils {
    ...
    private class func getVersionAtIndex(versionString: String, index: Int) -> Int {
        var pieces = versionString.characters.split {$0 == "."}.map { String($0) }
        if pieces.count > index, let version = Int(pieces[index]) {
            return version
        }  else {
            return 0
        }
    ...
    - parameter String1: The first string version to compare.
    - parameter String2: The second string version to compare.
